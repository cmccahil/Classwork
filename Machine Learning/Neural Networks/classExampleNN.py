...
def runNetwork(train, valid, test, neurons, learningRate, threshold, numAttributes, possibleLabels):
    ...
    while (validAcc < 0.99 and epoch < maxEpochs):
        epoch += 1
        ...
        if epoch % printEvery == 0:
            ...
            trainAcc = confusion_matrix.printAccuracy(cm)
            ...
            confusion_matrix.printConfusionMatrix(cm, possibleLabels)
            validAcc = confusion_matrix.printAccuracy(cm)
    ...
    print("Training accuracies:",listOfTrainAcc)
    print("Validation accuracies:",listOfvalidAcc)
