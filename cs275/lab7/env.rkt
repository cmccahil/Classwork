...
(define extended-env (lambda (syms vals old-env) (list 'extended-env syms (map box vals) old-env)))
...
(define init-env1  (extended-env '(True False) '(True False) (extended-env '(x) '(20) the-empty-env)))
